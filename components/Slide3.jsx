    ...
    <div className="timeline-container">
      <VerticalTimeline lineColor="#00C4AC" className="timeline">
        ...
        >
          ...
          {/* <h4 className="vertical-timeline-element-subtitle"></h4> */}
          <p style={{ color: "#00C4AC", marginTop: "0.5vw" }}>
            Powerful tool that detects suspicious URL's and provides a detailed
            report on the URL's safety.
          </p>
          <div className="project-links-row">
            <div className="project-link">
              <img src="./view.svg" />
        ...
        >
          ...
          <p style={{ color: "#00C4AC", marginTop: "0.5vw" }}>
            ...
            provides detailed information about the recognized person trained on
            the database of known faces.
          </p>
          <div className="project-links-row">
            <div className="project-link">
              <img src="./view.svg" />
